...
Пакетный запуск по разделам 01–14: Sozdat_vse_vedomosti.bat в корне дела.
"""
...
SECTIONS = {
    ...
    "12": {"name": "Разнарядки", "icon": "📋", "desc": "Разнарядки на социальное такси по периодам"},
    "13": {"name": "Путевые листы", "icon": "🚗", "desc": "Путевые листы транспорта"},
    "14": {"name": "Займы", "icon": "📎", "desc": "Договоры займа, реестр"},
}
